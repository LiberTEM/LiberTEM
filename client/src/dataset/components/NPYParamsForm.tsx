...
import { DatasetInfoNPY, DatasetParamsNPY, DatasetTypes } from "../../messages";
...
type FormValues = DatasetParamsNPYForForm

type MergedProps = FormikProps<FormValues> & OpenFormProps<DatasetParamsNPY, DatasetInfoNPY>;
