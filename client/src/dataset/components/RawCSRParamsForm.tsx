...
import { DatasetInfoRawCSR, DatasetParamsRawCSR, DatasetTypes } from "../../messages";
...
type MergedProps = FormikProps<DatasetParamsRawCSRForForm> & OpenFormProps<DatasetParamsRawCSR, DatasetInfoRawCSR>;
