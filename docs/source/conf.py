...
latex_documents = [
    (master_doc, 'LiberTEM.tex', 'LiberTEM Documentation',
...
man_pages = [
    (master_doc, 'libertem', 'LiberTEM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'LiberTEM', 'LiberTEM Documentation',
     author, 'LiberTEM', 'One line description of project.',
     'Miscellaneous'),
]
