...
__PYX_EXTERN_C DL_IMPORT(void) apply_mask(int, int, int, uint32_t *, uint32_t *, uint64_t *); /*proto*/
static PyObject *__pyx_f_4test_do_apply_mask(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_4test_do_apply_mask(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image_pixels, __Pyx_memviewslice __pyx_v_mask_pixels, __Pyx_memviewslice __pyx_v_out, int __pyx_v_num_masks, int __pyx_v_pixel_per_frame, int __pyx_v_num_frames); /* proto */
...
/* "bm.pyx":7
 * cdef extern void apply_mask(int m, int n, int k, uint32_t* A, uint32_t* B, uint64_t* C);
 * 
 * cpdef do_apply_mask(uint32_t[::view.contiguous] image_pixels,             # <<<<<<<<<<<<<<
 *                     uint32_t[::view.contiguous] mask_pixels,
 *                     uint64_t[::view.contiguous] out,
 */

static PyObject *__pyx_pw_4test_1do_apply_mask(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4test_do_apply_mask(__Pyx_memviewslice __pyx_v_image_pixels, __Pyx_memviewslice __pyx_v_mask_pixels, __Pyx_memviewslice __pyx_v_out, int __pyx_v_num_masks, int __pyx_v_pixel_per_frame, int __pyx_v_num_frames, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    if (unlikely(!(((__pyx_v_mask_pixels.shape[0]) == (__pyx_v_pixel_per_frame * __pyx_v_num_masks)) != 0))) {
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_mask_pixels.shape[0];
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_v_mask_pixels.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 15, __pyx_L1_error)
  }
  __pyx_t_3 = (&(*((uint32_t *) ( /* dim=0 */ ((char *) (((uint32_t *) __pyx_v_mask_pixels.data) + __pyx_t_1)) ))));
 ...
 */
  ...
  } else if (unlikely(__pyx_t_4 >= __pyx_v_image_pixels.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 16, __pyx_L1_error)
  }
  __pyx_t_5 = (&(*((uint32_t *) ( /* dim=0 */ ((char *) (((uint32_t *) __pyx_v_image_pixels.data) + __pyx_t_4)) ))));
 ...
 */
  ...
  } else if (unlikely(__pyx_t_6 >= __pyx_v_out.shape[0])) __pyx_t_2 = 0;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    __PYX_ERR(0, 17, __pyx_L1_error)
  }
  __pyx_t_7 = (&(*((uint64_t *) ( /* dim=0 */ ((char *) (((uint64_t *) __pyx_v_out.data) + __pyx_t_6)) ))));
 ...
 *         B=&image_pixels[0],
 */
  apply_mask(__pyx_v_num_masks, __pyx_v_num_frames, __pyx_v_pixel_per_frame, __pyx_t_3, __pyx_t_5, __pyx_t_7);
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("test.do_apply_mask", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4test_1do_apply_mask(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4test_1do_apply_mask(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("do_apply_mask (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mask_pixels)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("do_apply_mask", 1, 6, 6, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("do_apply_mask", 1, 6, 6, 2); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_masks)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("do_apply_mask", 1, 6, 6, 3); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pixel_per_frame)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("do_apply_mask", 1, 6, 6, 4); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_frames)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("do_apply_mask", 1, 6, 6, 5); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "do_apply_mask") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_image_pixels = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint32_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image_pixels.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_mask_pixels = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint32_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mask_pixels.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_out = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint64_t(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_out.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_num_masks = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_num_masks == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_pixel_per_frame = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_pixel_per_frame == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_num_frames = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_num_frames == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("do_apply_mask", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("test.do_apply_mask", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4test_do_apply_mask(__pyx_self, __pyx_v_image_pixels, __pyx_v_mask_pixels, __pyx_v_out, __pyx_v_num_masks, __pyx_v_pixel_per_frame, __pyx_v_num_frames);
...
static PyObject *__pyx_pf_4test_do_apply_mask(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image_pixels, __Pyx_memviewslice __pyx_v_mask_pixels, __Pyx_memviewslice __pyx_v_out, int __pyx_v_num_masks, int __pyx_v_pixel_per_frame, int __pyx_v_num_frames) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("do_apply_mask", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_image_pixels.memview)) { __Pyx_RaiseUnboundLocalError("image_pixels"); __PYX_ERR(0, 7, __pyx_L1_error) }
  if (unlikely(!__pyx_v_mask_pixels.memview)) { __Pyx_RaiseUnboundLocalError("mask_pixels"); __PYX_ERR(0, 7, __pyx_L1_error) }
  if (unlikely(!__pyx_v_out.memview)) { __Pyx_RaiseUnboundLocalError("out"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_4test_do_apply_mask(__pyx_v_image_pixels, __pyx_v_mask_pixels, __pyx_v_out, __pyx_v_num_masks, __pyx_v_pixel_per_frame, __pyx_v_num_frames, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"do_apply_mask", (PyCFunction)__pyx_pw_4test_1do_apply_mask, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
