...
class Pdb(OldPdb):
    ...
    def format_stack_entry(self, frame_lineno, lprefix=': ', context=None):
        ...
        Colors = self.color_scheme_table.active_colors
        ColorsNormal = Colors.Normal
        tpl_link = f'{Colors.filenameEm}%s{ColorsNormal}'
        tpl_call = f'{Colors.vName}%s{Colors.valEm}%s{ColorsNormal}'
        tpl_line = f'%s{Colors.lineno}%s {ColorsNormal}%s'
    ...
    def print_list_lines(self, filename, first, last):
        ...
        try:
            ...
            ColorsNormal = Colors.Normal
            tpl_line = f'%s{Colors.lineno}%s {ColorsNormal}%s'
            tpl_line_em = f'%s{Colors.linenoEm}%s {Colors.line}%s{ColorsNormal}'
            src = []
