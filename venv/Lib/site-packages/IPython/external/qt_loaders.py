...
class ImportDenier:
    ...
    def load_module(self, fullname):
        raise ImportError("""
    Importing {} disabled by IPython, which has
    already imported an Incompatible QT Binding: {}
    """.format(fullname, loaded_api()))
...
def load_qt(api_options):
    ...
    PyQt4 available (requires QtCore, QtGui, QtSvg):            {}
    PyQt5 available (requires QtCore, QtGui, QtSvg, QtWidgets): {}
    PySide >= 1.0.3 installed:                                  {}
    PySide2 installed:                                          {}
    Tried to load:                                              {!r}
    """.format(loaded_api(),
