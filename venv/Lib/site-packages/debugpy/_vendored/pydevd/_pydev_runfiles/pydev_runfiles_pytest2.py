...
def pytest_unconfigure():
    ...
    pydev_runfiles_xml_rpc.notifyTestRunFinished(
        f'Finished in: {time.time() - State.start_time:.2f} secs.')
...
if not hasattr(pytest, 'hookimpl'):
    raise AssertionError(f'Please upgrade pytest (the current version of pytest: {pytest.__version__} is unsupported)')
