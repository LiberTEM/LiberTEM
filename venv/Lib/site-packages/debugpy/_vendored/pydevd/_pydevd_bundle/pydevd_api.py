...
class PyDevdAPI:
    ...
    def request_suspend_thread(self, py_db, thread_id='*'):
        ...
        if suspend_all:
            ...
            sys.stderr.write(f"Can't suspend tasklet: {thread_id}\n")
    ...
    def request_step(self, py_db, thread_id, step_cmd_id):
        ...
        if t:
            ...
            sys.stderr.write(f"Can't make tasklet step command: {thread_id}\n")
    ...
    def request_smart_step_into(self, py_db, seq, thread_id, offset, child_offset):
        ...
        if t:
            ...
            sys.stderr.write(f"Can't set next statement in tasklet: {thread_id}\n")
    ...
    def to_str(self, s):
        ...
        if s.__class__ != str:
            if not IS_PY3K:
                ...
                raise AssertionError(f'Expected to have str on Python 3. Found: {s} ({s.__class__})')
        return s
    ...
    def filename_to_str(self, filename):
        ...
        if filename.__class__ != str:
            if not IS_PY3K:
                ...
                raise AssertionError(f'Expected to have str on Python 3. Found: {filename} ({filename.__class__})')
        return filename
    ...
    def add_breakpoint(
        ...
        '''
        assert original_filename.__class__ == str, f'Expected str, found: {original_filename.__class__}'  # i.e.: bytes on py2 and str on py3
        ...
        if file_to_id_to_breakpoint is None:
            ...
            try:
                ...
                if DebugInfoHolder.DEBUG_TRACE_BREAKPOINTS > 0:
                    ...
                    pydev_log.info('Removed breakpoint:{} - line:{} - func_name:{} (id: {})\n'.format(
