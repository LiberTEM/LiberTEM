...
class ReturnInfo:
    ...
    def __str__(self):
        return f'{{return: {self.return_line}}}'
...
def _get_line(op_offset_to_line, op_offset, firstlineno, search=False):
    ...
    while op_offset >= 0:
        ...
        if not search:
            ...
            op_offset -= 1
    raise AssertionError('Unable to find line for offset: {}.Info: {}'.format(
...
class _Disassembler:
    ...
    def _next_instruction_to_str(self, line_to_contents):
        ...
        if instruction.argval:
            return msg(instruction, f'{instruction.opname}{{{instruction.argval}}}')
