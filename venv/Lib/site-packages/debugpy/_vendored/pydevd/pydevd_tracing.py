...
def _load_python_helper_lib_uncached():
    ...
    if IS_WINDOWS:
        ...
        filename = os.path.join(os.path.dirname(__file__), 'pydevd_attach_to_process', f'attach_{suffix}.dll')
        ...
        filename = os.path.join(os.path.dirname(__file__), 'pydevd_attach_to_process', f'attach_linux_{suffix}.so')
        ...
        filename = os.path.join(os.path.dirname(__file__), 'pydevd_attach_to_process', f'attach_{suffix}')
...
def set_trace_to_threads(tracing_func, thread_idents=None, create_dummy_thread=True):
    ...
    if thread_idents is None:
        ...
        thread_idents = thread_idents.difference(
            ...
            {t.ident for t in threading.enumerate() if getattr(t, 'pydev_do_not_trace', False)}
        )
