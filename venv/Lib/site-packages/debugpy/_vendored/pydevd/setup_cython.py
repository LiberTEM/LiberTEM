...
def build_extension(dir_name, extension_name, target_pydevd_name, force_cython, extended=False, has_pxd=False, template=False):
    pyx_file = os.path.join(os.path.dirname(__file__), dir_name, f"{extension_name}.pyx")

    if template:
        pyx_template_file = os.path.join(os.path.dirname(__file__), dir_name, f"{extension_name}.template.pyx")
    ...
    if target_pydevd_name != extension_name:
        ...
        new_pyx_file = os.path.join(os.path.dirname(__file__), dir_name, f"{target_pydevd_name}.pyx")
        new_c_file = os.path.join(os.path.dirname(__file__), dir_name, f"{target_pydevd_name}.c")
        shutil.copy(pyx_file, new_pyx_file)
        pyx_file = new_pyx_file
        if has_pxd:
            pxd_file = os.path.join(os.path.dirname(__file__), dir_name, f"{extension_name}.pxd")
            new_pxd_file = os.path.join(os.path.dirname(__file__), dir_name, f"{target_pydevd_name}.pxd")
...
''')
        ...
        ext_modules = [
            Extension(
                "{}{}.{}".format(dir_name, "_ext" if extended else "", target_pydevd_name),
                c_files,
                **kwargs
            )]
