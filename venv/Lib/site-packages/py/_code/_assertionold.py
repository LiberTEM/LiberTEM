...
class View:
    ...
    def __repr__(self):
        return f'{self.__rootclass__.__name__}({self.__obj__!r})'
...
def report_failure(e):
    ...
    if explanation:
        ...
        explanation = ""
    sys.stdout.write(f"{e.exc.__name__}: {e.value}{explanation}\n")
...
def getmsg(excinfo):
    ...
    if not isinstance(x, str):
        raise TypeError(f"interpret returned non-string {x!r}")
    return x
